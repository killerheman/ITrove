...
<head>
    ...
    <title>Quote Request Acknowledgment - Innovation Trove</title>
    <style>
                    ...
                    <tr>
                        <td class="content-padding" style="padding: 36px 32px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; color: #4a5568;">
                                Thank you for considering <strong>Innovation Trove</strong> as your digital engineering partner. We have successfully received your project specifications, and our senior software architects are already reviewing your requirements.
                            </p>
                            ...
                            <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; margin-bottom: 28px;">
                                <div style="font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px; color: #000279; margin-bottom: 14px; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px;">
                                    <span style="color: #fb9506; margin-right: 6px;">&#9679;</span> Summary of Your Submission
                                </div>
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 14px; line-height: 1.6;">
                                    <tr>
                                        <td width="35%" style="padding: 6px 0; color: #718096; font-weight: 600; vertical-align: top;">Service Area:</td>
                                        <td width="65%" style="padding: 6px 0; color: #1a202c; font-weight: 700; vertical-align: top;">
                                            <span style="display: inline-block; background-color: #ebf4ff; color: #000279; padding: 2px 10px; border-radius: 12px; font-size: 13px; border: 1px solid #c3dafe;">
                                                {{ is_object($data) ? ($data->service ?? 'Custom Software Development') : ($data['service'] ?? 'Custom Software Development') }}
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    @php
                                        $desc = is_object($data) ? ($data->description ?? ($data->message ?? '')) : ($data['description'] ?? ($data['message'] ?? ''));
                                    @endphp
                                    @if(!empty($desc))
                                    <tr>
                                        <td style="padding: 8px 0 4px 0; color: #718096; font-weight: 600; vertical-align: top;">Project Scope:</td>
                            ...
                            <div style="margin-bottom: 28px;">
                                <h3 style="margin: 0 0 16px 0; font-size: 16px; font-weight: 700; color: #070b28;">
                                    What Happens Next?
                                </h3>

                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td width="36" style="vertical-align: top; padding-right: 12px; padding-bottom: 14px;">
                                            <div style="width: 28px; height: 28px; border-radius: 50%; background-color: #000279; color: #ffffff; font-weight: 700; font-size: 13px; text-align: center; line-height: 28px;">1</div>
                                        </td>
                                        <td style="vertical-align: top; padding-bottom: 14px;">
                                            <strong style="color: #1a202c; font-size: 14px;">Technical Scope & Feasibility Review</strong>
                                            <p style="margin: 2px 0 0 0; color: #718096; font-size: 13px; line-height: 1.5;">Our engineering team analyzes your tech stack, architecture, and timeline within <strong>12 to 24 business hours</strong>.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="36" style="vertical-align: top; padding-right: 12px; padding-bottom: 14px;">
                                            <div style="width: 28px; height: 28px; border-radius: 50%; background-color: #fb9506; color: #ffffff; font-weight: 700; font-size: 13px; text-align: center; line-height: 28px;">2</div>
                                        </td>
                                        <td style="vertical-align: top; padding-bottom: 14px;">
                                            <strong style="color: #1a202c; font-size: 14px;">Complimentary Discovery Consultation</strong>
                                            <p style="margin: 2px 0 0 0; color: #718096; font-size: 13px; line-height: 1.5;">We will reach out via email or WhatsApp to schedule a quick 20-minute discovery call to clarify any architectural nuances.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="36" style="vertical-align: top; padding-right: 12px; padding-bottom: 8px;">
                                            <div style="width: 28px; height: 28px; border-radius: 50%; background-color: #38a169; color: #ffffff; font-weight: 700; font-size: 13px; text-align: center; line-height: 28px;">3</div>
                                        </td>
                                        <td style="vertical-align: top; padding-bottom: 8px;">
                                            <strong style="color: #1a202c; font-size: 14px;">Detailed Milestone Roadmap & Estimate</strong>
                                            <p style="margin: 2px 0 0 0; color: #718096; font-size: 13px; line-height: 1.5;">You will receive an itemized cost estimate, sprint breakdown, and NDA protection guarantee with zero obligation.</p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="background: linear-gradient(135deg, #070b28 0%, #1a1f5c 100%); border-radius: 8px; padding: 22px; color: #ffffff; margin-bottom: 28px; text-align: center;">
                                <h4 style="margin: 0 0 8px 0; font-size: 16px; color: #ffffff; font-weight: 700;">
                                    Have an Urgent Launch Deadline or Need an NDA?
                                </h4>
                                <p style="margin: 0 0 16px 0; font-size: 13px; color: #cbd5e0; line-height: 1.5;">
                                    You can connect directly with our Technical Solutions Director right away:
                                </p>
                                <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin: 0 auto;">
                                    <tr>
                                        <td style="padding: 0 8px;">
                                            <a href="https://wa.me/919648061515?text=Hi%20Innovation%20Trove%2C%20I%20just%20submitted%20a%20quote%20request%20for%20my%20project." target="_blank" style="display: inline-block; background-color: #25d366; color: #ffffff; text-decoration: none; font-size: 13px; font-weight: 700; padding: 10px 18px; border-radius: 6px;">
                            ...
                            <div style="text-align: center; margin-bottom: 10px;">
                                ...
                                <a href="{{ route('services') }}" target="_blank" style="display: inline-block; background-color: #edf2f7; color: #000279; text-decoration: none; font-size: 13px; font-weight: 700; padding: 10px 22px; border-radius: 6px; margin: 4px; border: 1px solid #cbd5e0;">
                                    Browse All Engineering Services &rarr;
                                </a>
                            </div>
                    ...
                    <tr>
                        <td style="background-color: #0b0f30; padding: 28px 30px; text-align: center; color: #a0aec0; font-size: 12px; line-height: 1.6; border-top: 1px solid #1a202c;">
                            ...
                            <div style="font-size: 11px; color: #718096; border-top: 1px solid #1f2937; padding-top: 12px; margin-top: 12px;">
                                &copy; {{ date('Y') }} Innovation Trove. All rights reserved. This email confirms your project inquiry submission.
                            </div>
                        </td>
                    </tr>
